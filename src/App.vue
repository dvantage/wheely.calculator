...
<script lang="ts">
    ...
    export default class App extends Vue {
        ...
        public tariffs = {
            business: {
                base:            275, // Начальная стоиомость
                time:            22,  // Стоимость за минуту поездки
                distance:        22,  // Стоимость за 1км поездки (в городе)
                distanceCountry: 32,  // Стоимость за 1км поездки (за городом)
                min:             500  // Минимальная стоимость
            },
            vip:      {
                base:            500,
                time:            40,
